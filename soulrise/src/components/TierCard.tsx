        ...
        <div className="max-w-sm flex flex-col justify-between p-6 bg-white border border-slate-100 rounded-lg shadow">
            <div>
                <div className="flex flex-row justify-between items-center">
                    <p className="text-2xl font-semibold text-black dark:text-black">{tier.name}</p>
                    <p className="text-2xl font-semibold text-black dark:text-black">${tier.amount.toString()}</p>
                </div>
            </div>
            <div className="flex flex-row justify-between items-end">
                <p className="text-xs font-semibold text-grey-800 dark:text-black">Total Backers: {tier.backers.toString()}</p>
                <TransactionButton
