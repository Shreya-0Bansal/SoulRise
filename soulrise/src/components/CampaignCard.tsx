    ...
    return (
                    <div className="flex flex-col justify-between max-w-sm p-6 bg-white border border-slate-200 rounded-lg shadow">
                        <div>
                            ...
                            <h5 className="mb-2 text-2xl text-gray-700 font-bold dark:black">{campaignName}</h5>
                            <p className="mb-3 font-normal text-gray-700 dark:black">{campaignDescription}</p>
                        </div>
    
                        <Link href={`/campaign/${campaignAddress}`} 
                        passHref={true}>
                        <p className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-400 rounded-lg hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-orange-200 dark:bg-orange-400 dark:hover:bg-orange-500 dark:focus:ring-orange-600">
    View Campaign
